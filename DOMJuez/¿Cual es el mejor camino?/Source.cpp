...
/*@ <answer>
 ...
 El coste de la función en el peor de los casos es O(K * ( (A * log(V) + (V + A) ) ), donde K es el número de consultas que se realizan, A el número de aristas y V el número de vértices del grafo
